...
public class Boss extends Person {
    ...
    public static LocalTime start = LocalTime.of(0, 1);
    public static LocalTime end = LocalTime.of(23, 59);
    ...
    public void addEmployee(Employee employee) {
        ...
        try {
            new Employment(this, employee, LocalDate.now());
        } catch (Exception e) {
    ...
    public HighExperienced promote(Employee employee) {
        HighExperienced promoted = new HighExperienced(employee, "BMW");
