...
public class Client extends Person {
    ...
    public Client(String name, String surname, LocalDate birthDate, Sex sex,
                  Address address, boolean hasClubCard, Citizenship citizenship) {
    ...
    public static boolean clientExists(String name,
        ...
        for (Client client : getClientExtent()) {
            if (client.getPersonName().equalsIgnoreCase(name)
                    ...
                    && Objects.equals(client.getCitizenship().orElse(null), citizenship)) {
                return true;
            }
        }
